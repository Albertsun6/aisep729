...
- 重批：门禁④批准（锚 2fe7419）后正文有修订——E-2 风险行按实测闭环改写（b2a66ba），修订不改变放行结论。2026-08-01 platform-hardening 评审复核属实，补此重批留痕（check-gate-immutability.sh 上线时的存量整改）｜ 批准人：yongqian（人类，以本 PR 合并为服务端确认）
